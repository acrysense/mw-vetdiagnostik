...
document.addEventListener('DOMContentLoaded', function () {
    ...
    loader.load(modelFile, function (gltf) {
      ...
      var tl = gsap.timeline({
        ...
        onEnter: function onEnter() {
          console.log("Секция вошла - onEnter: запускаем анимацию или видео");
        },
        onLeave: function onLeave() {
          console.log("Секция покинута вниз - onLeave: останавливаем анимацию или видео");
        },
        onEnterBack: function onEnterBack() {
          console.log("Секция вошла с обратной стороны (снизу) - onEnterBack: запускаем анимацию или видео");
        },
        onLeaveBack: function onLeaveBack() {
          console.log("Секция покинута вверх - onLeaveBack: останавливаем анимацию или видео");
        }
      });
      tl.to(".main__wrap", {
        duration: 0.3,
  ...
  lottie.loadAnimation({
    ...
    autoplay: true,
    // автозапуск анимации
    path: 'techBG.json' // путь к JSON файлу анимации
  });
});